...
/**
 * IBLogo - Custom Hexagonal iB Logo Component
 * Renders the exact geometric iB hexagon logo.
 */
export default function IBLogo({ className = "w-8 h-8" }) {
  return (
    <svg
      viewBox="0 0 200 230"
      fill="none"
      ...
      aria-label="InnoBridge Hexagonal Logo"
    >
      {/* Left Side: Dark Blue Frame & Stem for 'i' */}
      <path
        ...
        fill="#0C3B73"
      />
      <polygon points="66,54 97,36 97,60 66,78" fill="#0066CC" />
      <polygon points="66,85 97,67 97,215 66,197" fill="#082C59" />

      {/* Right Side: Bright Azure Blue 'B' Completing Hexagon */}
      <path
