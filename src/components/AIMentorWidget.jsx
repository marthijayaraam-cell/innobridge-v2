...
export default function AIMentorWidget({ currentProjectContext = null }) {
  ...
  const quickPrompts = userRole === 'faculty' ? [
    ...
    "Pitch deck formula",
    "How to get faculty sponsorship?"
  ];
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isOpen ? (
        <div className="bg-[#111827] w-96 max-w-[calc(100vw-2rem)] h-[500px] max-h-[82vh] rounded-md border border-slate-800 shadow-md flex flex-col overflow-hidden animate-fade-in">
          ...
          <div className="px-3 py-2 bg-[#0B1120] border-t border-slate-800 flex items-center gap-1.5 overflow-x-auto no-scrollbar">
          ...
          <form
            ...
            className="p-2.5 bg-[#0B1120] border-t border-slate-800 flex items-center gap-2"
          >
            <input
              type="text"
