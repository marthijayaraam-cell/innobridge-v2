            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#0B1120] border-2 border-[#334155] focus:border-emerald-500 text-white text-base font-extrabold outline-none transition-colors cursor-pointer"
                >
                  {DOMAINS.map((d) => (
