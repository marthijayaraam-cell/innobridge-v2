    ...
    <div className="min-h-screen w-full bg-[#0B1120] text-[#F8FAFC] py-8 sm:py-12 px-4 sm:px-8 lg:px-12 xl:px-16 max-w-[1600px] mx-auto">
      ...
      {reviewingProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-[#111827] w-full max-w-lg rounded-2xl p-6 border border-[#334155] shadow-card relative">
            <button
            ...
            <div className="mb-4 p-3 rounded-xl bg-[#0B1120] border border-aiIndigo/30 flex items-center justify-between text-xs">
              <span className="text-slate-400 font-medium">AI Overall Evaluation Benchmark:</span>
              <span className="badge-ai font-extrabold px-2.5 py-0.5 rounded-md">
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 p-3 rounded-xl bg-[#0B1120] border border-[#334155] justify-center">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      type="button"
                      key={star}
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-xs font-bold flex items-center justify-center gap-2 transition-all ${
                      status === 'Approved'
                        ...
                        : 'bg-[#0B1120] border-[#334155] text-slate-400'
                    }`}
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-xl bg-[#0B1120] border border-[#334155] focus:border-emerald-500 text-slate-100 text-xs outline-none"
                />
              </div>
