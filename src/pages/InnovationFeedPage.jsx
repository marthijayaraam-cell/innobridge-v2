  ...
  return (
    <div className="min-h-screen w-full bg-[#0B1120] text-slate-100 py-8 sm:py-12 px-4 sm:px-8 lg:px-12 xl:px-16 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 border-b border-slate-800 pb-6">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-slate-900 border border-slate-700 text-xs font-medium text-emerald-400 mb-2">
        ...
        <button
          ...
          className="self-start md:self-auto px-3.5 py-1.5 rounded-md bg-slate-800 border border-slate-700 hover:border-slate-600 text-xs font-medium text-slate-300 hover:text-white flex items-center gap-2 transition-colors"
        >
      ...
      <div className="bg-[#111827] p-4 sm:p-5 rounded-md border border-slate-800 mb-8 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-md bg-slate-900 border border-slate-700 focus:border-emerald-500 text-slate-100 text-xs outline-none transition-colors font-normal"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
          ...
          <div>
            <label className="block text-[11px] font-medium text-slate-400 uppercase tracking-wider mb-1 flex justify-between">
              ...
              <span className="text-emerald-400 font-semibold">{minAIScore}+</span>
            </label>
            <input
              type="range"
              min="0"
              ...
              className="w-full accent-emerald-500 bg-slate-900 h-2 rounded-md cursor-pointer"
            />
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-[#111827] rounded-md p-12 text-center border border-slate-800">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-md bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-medium transition-colors"
          >
            Reset All Filters
          </button>
        </div>
